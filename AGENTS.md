...
Skills Dispatcher
When performing these actions, ALWAYS invoke the corresponding skill FIRST by reading the file:

Action,Skill Path
When no skill is found, load C:\FECQR\FECQR\.agents\skills\find-skills\SKILL.md
When designing frontend web pages, load C:\FECQR\FECQR\.agents\skills\frontend-design\SKILL.md
